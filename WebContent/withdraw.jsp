				 	...
				 	<td width="1200" valign="top">
					 	...
					 	<table>
					 		...
					 		<%
					 			...
					 			int amounts = Integer.parseInt(amoun);
					 			...
					 			try
					 			{
				 					...
				 					if(status)
				 					{
				 						...
				 						if(rs.next())
				 						{
				 							dataamount = rs.getInt(5)-amounts;
				 						}
				 						...
				 						//if(rs.next())
				 						//{
				 							out.print("Your Balance has updated");
				 							request.setAttribute("totaldataamount", dataamount);
				 							request.setAttribute("balance", "Your Balance has Updated Successfully and your current Balance is ");
