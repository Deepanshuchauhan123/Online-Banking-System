		...
		try
		{
			...
			if(status == 0)
			{
				...
				if(status == 2)
				{
					...
					PreparedStatement ps = con.prepareStatement("CREATE TABLE NEWACCOUNT(ACCOUNTNO NUMBER, USERNAME VARCHAR2(4000),PASSWORD VARCHAR2(4000), REPASSWORD VARCHAR2(4000),AMOUNT VARCHAR2(4000),ADDERESS VARCHAR2(4000),PHONE NUMBER,PRIMARY KEY (ACCOUNTNO))");
						ps.executeUpdate();
				}
				else
				{
